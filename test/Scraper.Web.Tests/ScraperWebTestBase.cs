...
{
    public abstract class ScraperWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ScraperWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ScraperWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ScraperDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ScraperDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ScraperDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ScraperDbContext, Task<T>> func)
        {
            T result;
