...
namespace Scraper.Migrations
{
    ...
    [Migration("20200925204330_CreateCarAdvertisement")]
    partial class CreateCarAdvertisement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scraper.CarAdvertisements.CarAdvertisement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Scraper.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Scraper.Authorization.Users.User", null)
                        .WithMany("Claims")
